...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        $data['today_feedback']=Feedback::whereDate('created_at',today())->count();
        $data['total_feedback']=Feedback::count();
        $data['today_bussiness']=Bussiness::whereDate('created_at',today())->count();
        $data['total_bussiness']=Bussiness::count();
