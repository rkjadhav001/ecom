                    ...
                    <div class="flex-between gx-2 gx-lg-3 mb-2">
                        ...
                        <div>
                            ...
                            <h4><i style="font-size: 30px"
                                   ...
                                   class="tio-chart-bar-4"></i>{{('Dashboard order statistics')}}</h4>
                    ...
                    <div class="flex-between gx-2 gx-lg-3 mb-2">
                        ...
                        <div>
                            ...
                            <h4><i style="font-size: 30px"
                                   ...
                                   class="tio-chart-line-up"></i>{{(' Report')}}</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="flex-between gx-2 gx-lg-3 mb-2">
                        ...
                        <div>
                            ...
                            <h4><i style="font-size: 30px" class="tio-map"></i>{{('Bussiness Report')}}</h4>
                    ...
                    <div class="row gx-2 gx-lg-3" id="order_stats">
                        ...
                        @include('admin-views.partials._dashboard-bussiness-stats',['data'=>$data])
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4 col-12 graph-border-1">
                                    ...
                                    <span class="h6 mb-0">
                                        ...
                                        {{('In-house earning with delivery charge')}} : {{array_sum($inhouse_data)}}
