        ...
        <div class="card-body">
            <div class="flex-between align-items-center mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: white!important;">{{('pending')}}</h6>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['confirmed'])}}" style="background: #001E6C">
        <div class="card-body">
            <div class="flex-between align-items-center mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: white!important;">{{('confirmed')}}</h6>
                     <span class="card-title h2" style="color: white!important;">
                         {{$data['confirmed']}}
                     </span>
                </div>
    ...
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['processing'])}}" style="background: #053742">
        <div class="card-body">
            <div class="flex-between align-items-center gx-2 mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: white!important;">{{('Processing')}}</h6>
                    <span class="card-title h2" style="color: white!important;">
                        {{$data['processing']}}
                    </span>
                </div>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['out_for_delivery'])}}" style="background: #343A40">
        <div class="card-body">
            <div class="flex-between align-items-center gx-2 mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: white!important;">{{('out for delivery')}}</h6>
                    <span class="card-title h2" style="color: white!important;">
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['delivered'])}}" style="background: #3E215D">
        <div class="card-body">
            <div class="flex-between align-items-center mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: white!important;">{{('delivered')}}</h6>
                    <span class="card-title h2" style="color: white!important;">
                        {{$data['delivered']}}
                    </span>
                </div>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="{{route('admin.orders.list',['canceled'])}}" style="background: #053742">
        <div class="card-body">
            <div class="flex-between align-items-center gx-2 mb-1">
                <div style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <h6 class="card-subtitle" style="color: white!important;">{{('canceled')}}</h6>
                    <span class="card-title h2" style="color: white!important;">
                        {{$data['canceled']}}
                    </span>
                </div>
