                ...
                <div class="media-body">
                    <div class="row">
                        <div class="row col-lg mb-3 mb-lg-0 {{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}" style="display: block; text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            <div>
                                <h1 class="page-header-title">{{('Earning')}} {{('Report')}}  {{('Overview')}} </h1>
                            </div>
            ...
            <div class="col-lg-12">
                <form action="{{route('admin.report.set-date')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">{{('show_data_by_date_range')}}</label>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1">{{('Total')}} {{('earning')}} </h4>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1">{{('Total')}} {{('commission')}} </h4>
        ...
        <div class="card mb-3 mb-lg-5 border-top border-left border-right border-bottom">
            ...
            <div class="card-header">
                ...
                <div class="flex-start">
                    <h6 class="card-subtitle mt-1">{{('total_sale_of')}} {{date('Y')}} :</h6>
