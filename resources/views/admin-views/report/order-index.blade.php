    ...
    <div class="content container-fluid">
                        ...
                        <div class="col-lg mb-3 mb-lg-0 {{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}" style="display: block; text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            ...
                            <div class="row align-items-center">
                                <div class="flex-between col-auto">
                                    <h5  class="text-muted {{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}">{{('Admin')}} :</h5>
        ...
        <div class="row border-bottom border-right border-left border-top">
            <div class="col-lg-12">
                <form action="{{route('admin.report.set-date')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                <input type="date" name="from" id="from_date" value="{{ session('from_date') }}"
                                       class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                                <input type="date" name="to" id="to_date" value="{{ session('to_date') }}"
                                       class="form-control" required>
                            </div>
                        </div>
                        <div class="col-4">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-6">
                @php
                    $returned=\App\Model\Order::where(['order_status'=>'confirmed'])->whereBetween('created_at', [$from, $to])->count()
                @endphp
                <!-- Card -->
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-6">
                @php
                    $failed=\App\Model\Order::where(['order_status'=>'out_for_delivery'])->whereBetween('created_at', [$from, $to])->count()
                @endphp
                <!-- Card -->
                <div class="card card-sm">
                    <div class="card-body">
                ...
                <div class="hs-unfold">
                    <a class="js-hs-unfold-invoker btn btn-white"
                       href="{{route('admin.orders.list',['status'=>'all'])}}">
                        <i class="tio-shopping-cart-outlined {{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}"></i> {{('Orders')}}
                    </a>
                </div>
                <!-- End Unfold -->
            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm mb-2 mb-sm-0">
                                                    <h2 class="font-weight-normal mb-1">#{{$order['id']}} <small
                                                            class="font-size-sm text-body text-uppercase">{{('Orders')}} {{('ID')}}</small>
                                                    </h2>
                                                    <h5 class="text-hover-primary mb-0">{{('Order')}} {{('Amount')}}
                                                ...
                                                <div class="col-sm-auto align-self-sm-end">
                                                    <!-- Avatar Group -->
                                                    <div class="">
                                                        {{('Orders')}}  {{str_replace('_',' ',$order['order_status']) }} <br></strong>
                                                    </div>
                                                    <!-- End Avatar Group -->
                                                </div>
                                            </div>
                                       ...
                                       href="{{route('admin.orders.details',['id'=>$order['id']])}}">
                                        <div class="card-body py-0">
                                            <div class="row">
                                                <div class="col-sm mb-2 mb-sm-0">
                                                    <h2 class="font-weight-normal mb-1">#{{$order['id']}} <small
                                                            class="font-size-sm text-body text-uppercase">{{('ID')}}</small>
                                                    </h2>
                                                    <h5 class="text-hover-primary mb-0">{{('Order')}} {{('Amount')}}
                                                        : {{\App\CPU\BackEndHelper::usd_to_currency($order['order_amount'])}} {{\App\CPU\BackEndHelper::currency_symbol()}}</h5>
                                                    <small
                                                ...
                                                <div class="col-sm-auto align-self-sm-end">
                                                    ...
                                                    <div class="text-capitalize">
                                                        {{('Status')}} <strong> : {{ str_replace('_',' ',$order['order_status']) }} <br></strong>
                                                    </div>
                                                    <!-- End Avatar Group -->
                                                </div>
                                            </div>
