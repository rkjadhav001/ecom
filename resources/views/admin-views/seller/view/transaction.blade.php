                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <select class="form-control" name="status">
                                            ...
                                            <option class="text-center" value="0" selected disabled>---{{('select status')}}---</option>
                                                <option class="text-left text-capitalize" value="disburse" {{ $status == 'disburse'? 'selected' : '' }} >{{('disburse')}} </option>
                                                <option class="text-left text-capitalize" value="hold" {{ $status == 'hold'? 'selected' : '' }}>{{('hold')}}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
