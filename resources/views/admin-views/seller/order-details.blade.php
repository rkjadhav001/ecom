                    ...
                    <div class="d-sm-flex align-items-sm-center">
                        ...
                        @if(\App\CPU\Helpers::get_business_settings('order_verification'))
                            <span class="ml-2 ml-sm-3">
                                <b>
                                    {{('order_verification_code')}} : {{$order['verification_code']}}
                                </b>
                            </span>
                        @endif
                    </div>
                                ...
                                <div class="dropdown">
                                    <select name="order_status" onchange="order_status(this.value)"
                                        ...
                                        <option class="text-capitalize"
                                            value="out_for_delivery" {{$order->order_status == 'out_for_delivery'?'selected':''}} >{{('out_for_delivery')}} </option>
                                        <option
                                        ...
                                        <option
                                            value="canceled" {{$order->order_status == 'canceled'?'selected':''}} >{{('Canceled')}} </option>
                    ...
                    <div class="card-header" style="display: block!important;">
                        <div class="row">
                            ...
                            <div class="col-12 text-right">
                                <div>
                                    <h6 class="text-capitalize" style="display: inline; color: #8a8a8a; ">{{('payment')}} {{('method')}} :</h6>
                                    <h6 class="mx-1" style="display: inline; color: #8a8a8a;">{{str_replace('_',' ',$order['payment_method'])}}</h6>
                                </div>
                                <div>
                                    <h6 style="display: inline; color: #8a8a8a;">{{('Payment')}} {{('reference')}} :</h6>
                                    <h6 class="mx-1" style="display: inline; color: #8a8a8a;">{{str_replace('_',' ',$order['transaction_ref'])}}</h6>
                                </div>
                                <div>
                                    <h6 class="text-capitalize" style="display: inline; color: #8a8a8a; ">{{('shipping')}} {{('method')}} :</h6>
