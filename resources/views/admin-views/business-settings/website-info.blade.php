    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"
                    aria-current="page">{{('Website')}} {{('Info')}} </li>
            </ol>
        </nav>
        ...
        <div class="row" style="padding-bottom: 20px;">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center"><i
                                class="tio-money"></i> {{('Currency Symbol Position')}}</h5>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center">{{('apple_store')}} {{('Status')}}</h5>
                    </div>
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 10px">{{('link')}}</label><br>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center">{{('google_play_store')}} {{('Status')}}</h5>
                    </div>
                    <div class="card-body" style="padding: 20px">
            ...
            <form action="{{ route('admin.business-settings.update-info') }}" method="POST"
                ...
                <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label
                                class="input-label">{{('company')}} {{('name')}}</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label
                                class="input-label">{{('company')}} {{('Email')}}</label>
                ...
                <div class="row" style="padding-bottom: 20px">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <label
                                class="input-label">{{('pagination')}} {{('settings')}}</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label
                                class="input-label">{{('rename_company')}} {{('copy_right')}} {{('Text')}}</label>
                ...
                <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label
                                class="input-label d-inline text-capitalize">{{('time')}} {{('zone')}}</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label
                                class="input-label d-inline text-capitalize">{{('country')}} </label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label
                                class="input-label d-inline text-capitalize">{{('forgot_password_verification_by')}} </label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <div class="form-group">
                            <label>{{('email')}} {{('verification')}}</label><small
                    ...
                    <div class="col-md-4 col-12">
                        ...
                        <div class="form-group">
                            <label>{{('order')}} {{('verification')}}</label><small
                                style="color: red">*</small>
                            <div class="input-group input-group-md-down-break">
                                <!-- Custom Radio -->
                                <div class="form-control">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label"
                                               for="order_verification1">{{('on')}}</label>
                                    </div>
                                </div>
                                <!-- End Custom Radio -->
                                ...
                                <div class="form-control">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label"
                                               for="order_verification2">{{('off')}}</label>
                                    </div>
                                </div>
                                <!-- End Custom Radio -->
                            </div>
