                            ...
                            <div class="col-md-6">
                                ...
                                @foreach(json_decode($language) as $lang)
                                    <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                            id="{{$lang}}-form">
                                        <label for="input-name">{{ ('name')}} ({{strtoupper($lang)}})</label>
                                ...
                                <div class="form-group">
                                    <label for="name">{{ ('brand logo')}}</label><span class="badge badge-soft-danger">( {{('ratio')}} 1:1 )</span>
                                    <div class="custom-file" style="text-align: left" required>
                                        <input type="file" name="image" id="customFileUpload" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label" for="customFileUpload">{{('choose')}} {{('file')}} {{('400 * 400')}}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
