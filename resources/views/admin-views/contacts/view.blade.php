    ...
    <div class="content container-fluid">
        ...
        <div class="container">
            <div class="d-sm-flex align-items-center justify-content-between mb-2">
                <h1 class="h3 mb-0 text-black-50">{{('View_User_Message')}}</h1>
            </div>
                        ...
                        <div class="card-body mt-3 ml-4">
                            <div class="row " style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                                ...
                                <div class=" col-md-9 col-lg-9 hidden-xs hidden-sm">
                                    ...
                                    @if($contact->seen==1)
                                        <label
                                            style="color: green; border: 1px solid;padding: 2px;border-radius: 10px">{{('Seen')}}</label>
                                    @else
                                        <label
                                            style="color: red; border: 1px solid;padding: 2px;border-radius: 10px">{{('Not_Seen_Yet')}}</label>
                                    @endif
                                    <br>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            @else
                                                <label class="badge badge-danger">{{('No_reply')}}.</label>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-10">
                                                    ...
                                                    <textarea class="form-control " name="feedback" id="" rows="5"
                                                              placeholder="{{('Please_send_a_Feedback')}}">{{$contact->feedback}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12 mt-4">
                                    <center>
                                        <h3>{{('Send_Mail')}}</h3>
                                        <label class="badge badge-soft-danger">{{('Configure_your_mail_setup_first')}}.</label>
                                    </center>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    ...
                                                    <textarea class="form-control " name="mail_body" id="" rows="5"
                                                              placeholder="{{('Please_send_a_Feedback')}}"></textarea>
                                                </div>
                                            </div>
                                        </div>
