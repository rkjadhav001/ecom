...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;700&family=Titillium+Web:wght@400;600;700&display=swap"
        rel="stylesheet">
    
    
    <!-- Global site tag (gtag.js) - Google Ads: 10849159823 -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-10849159823"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'AW-10849159823');
    </script>
...
<script type="text/javascript">
    (function() {
        var options = {
            whatsapp: "+918591282038", // WhatsApp number
        ...
        if ($('#add-to-cart-form input[name=quantity]').val() > 0 && checkAddToCartValidity()) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#chosen_price12').html(data.product_price);
                    $('#without_discount').html(data.without_discount);
